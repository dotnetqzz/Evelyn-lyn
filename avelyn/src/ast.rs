...
pub enum ASTNode {
    ...
    // Declarations
    Decl { name: String, value: Box<ASTNode>, mutable: bool },
    ...
    // Functions
    FuncDecl { name: String, params: Vec<Param>, body: Vec<ASTNode>, variadic: bool },
    FuncCall { name: String, args: Vec<ASTNode> },
    Lambda { params: Vec<Param>, body: Vec<ASTNode>, variadic: bool },
